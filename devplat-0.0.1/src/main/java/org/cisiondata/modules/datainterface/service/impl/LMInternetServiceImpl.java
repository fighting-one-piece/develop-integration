...
public class LMInternetServiceImpl implements ILMInternetService {
	...
	public Map<String, Object> readBankPhone(String phone) throws BusinessException {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				binddata = HttpUtils.sendPost(Constants.TEST_URL + "/queryPhoneBankCardBindInfo", map,
						Constants.APP_KEY, Constants.APP_KEY_VALUE);
				activedata = HttpUtils.sendPost(Constants.TEST_URL + "/queryActive", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				loaddata = HttpUtils.sendPost(Constants.TEST_URL + "/queryLoadInfo", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				changeLine = HttpUtils.sendPost(Constants.TEST_URL + "/queryAccountChangeLines", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				binddata = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryPhoneBankCardBindInfo", map,
						Constants.APP_KEY, Constants.APP_KEY_VALUE);
				activedata = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryActive", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				loaddata = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryLoadInfo", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				changeLine = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryAccountChangeLines", map,
						Constants.APP_KEY, Constants.APP_KEY_VALUE);
				break;
			}
			// 存储状态码
			...
			if (code == 200) {
				if (flagcode == 1) {
					Map<String, Map<String, Object>> maps = (Map<String, Map<String, Object>>) mapresult.get("data")
							.get("result");
					for (Map.Entry<String, Map<String, Object>> entry : maps.entrySet()) {
						...
						if (entry.getKey().equals("debitCardPayment3m")) {
							...
							for (Map.Entry<String, Object> en : mapRs.entrySet()) {
			...
			if (loadcode == 200) {
				if (loadflag == 1) {
					...
					for (Map.Entry<String, Map<String, Object>> entry : maps.entrySet()) {
						Map<String, Object> mapRs = new HashMap<String, Object>();
						if (entry.getKey().equals("currentOutstandingLoanAmount")) {
							mapRs = entry.getValue();
							for (Map.Entry<String, Object> en : mapRs.entrySet()) {
								if (en.getKey().equals("minIncluded")) {
						...
						if (entry.getKey().equals("currentOutstandingLoanCount")) {
			...
			if (activecode == 200) {
				if (activeflag == 1) {
					Map<String, Object> maps = (Map<String, Object>) mapresult.get("data").get("result");
					for (Map.Entry<String, Object> entry : maps.entrySet()) {
						if (entry.getKey().equals("paymentShortTermVolatilityIndex")) {
							mapJ.put("出账短期波动指数", entry.getValue());
						}
						if (entry.getKey().equals("depositShortTermVolatilityIndex")) {
							mapJ.put("入账短期波动指数", entry.getValue());
						}
						if (entry.getKey().equals("depositLongTermVolatilityIndex")) {
	...
	public Map<String, String> auditphone(String phone) throws BusinessException {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/audit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/audit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/audit", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Map<String, String> court_executedPeopleB(String idCard, String name, String phone)
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/court/executedPeopleB", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/court/executedPeopleB", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk
			// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20170114143705429CvpACMSNCaPSvhJ\",\"data\":{\"result\":{\"content\":[{\"Execution\":{\"court_bad1\":{\"casenum\":\"(2016)建执字第00047号\",\"breaktime\":\"\",\"datatime\":\"\",\"posttime\":\"2016年05月11日\",\"basecompany\":\"黑龙江省建三江农垦法院\",\"cidtype\":\"\",\"court\":\"黑龙江省建三江农垦法院\",\"unperformpart\":\"\",\"datatypeid\":102,\"cid\":\"2308191981****1510\",\"concretesituation\":\"其他有履行能力而拒不履行生效法律文书确定义务\",\"obligation\":\"一、被告张晓雨、贾兴玲偿还原告李永良欠款210
			// 000元，利息14 580元，合计224 580元，于2015年12月31日履行；二、银行贷款的滞纳金原告按50
			// 000元，被告按210
			// 000元各自承担；案件受理费4192元，减半收取2096元，由原告李永良承担500元，被告张晓雨承担1596元。\",\"time\":\"2016年01月07日\",\"lasttime\":\"\",\"address\":\"黑龙江\",\"performance\":\"全部未履行\",\"name\":\"张晓雨\",\"leader\":\"\",\"performedpart\":\"\",\"money\":\"\",\"base\":\"（2015）建商初字第428号\",\"datatype\":\"失信被执行人\"},\"court_executed2\":{\"statute\":\"已结案\",\"casenum\":\"(2015)建执字第00034号\",\"time\":\"2015-01-19\",\"datatime\":\"2015-01-19\",\"basic\":\"\",\"name\":\"张晓雨\",\"money\":\"26176.00\",\"cidtype\":1,\"court\":\"黑龙江省建三江农垦法院\",\"datatypeid\":103,\"datatype\":\"最高法执行\",\"cid\":\"230819198104171510\",\"basiccourt\":\"\"},\"court_executed1\":{\"statute\":\"\",\"casenum\":\"(2016)建执字第00047号\",\"time\":\"2016-01-07\",\"datatime\":\"\",\"basic\":\"\",\"name\":\"张晓雨\",\"money\":\"244580\",\"cidtype\":\"\",\"court\":\"黑龙江省建三江农垦法院\",\"datatypeid\":103,\"datatype\":\"最高法执行\",\"cid\":\"2308191981****1510\",\"basiccourt\":\"\"}},\"Flag\":{\"execution\":\"1\"}}]}}}";
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/court/executedPeopleB", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
	...
	public Map<String, String> education_organizeF(String idCard, String name) throws BusinessException {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/education/organizeF", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/education/organizeF", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/education/organizeF", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readLoanInfo(String phone) throws BusinessException {
		...
		map.put("phone", phone);
		// 测试JSON
		// String kk = "{\"errorCode\": 200,\"errorMsg\": \"请求成功\",\"uid\":
		// \"20161205100516170IAWlTRsIPDqNykk\",\"data\": {\"PHONE\":
		// \"18610025754\",\"PROVINCE\": \"北京\",\"RESULTS\": [{\"DATA\":
		// [{\"P_TYPE\": \"2\",\"REGISTERTIME\": \"2016/6/16
		// 0:00:00\",\"PLATFORMCODE\": \"EM_112197\"},{\"P_TYPE\":
		// \"2\",\"REGISTERTIME\": \"2016/6/22 0:00:00\",\"PLATFORMCODE\":
		// \"EM_110237\"},{\"P_TYPE\": \"2\",\"REGISTERTIME\": \"2016/5/25
		// 0:00:00\",\"PLATFORMCODE\": \"EM_103071\"},{\"P_TYPE\":
		// \"2\",\"REGISTERTIME\": \"2016/5/10 0:00:00\",\"PLATFORMCODE\":
		// \"EM_103071\"},{\"P_TYPE\": \"2\",\"REGISTERTIME\": \"2016/5/25
		// 0:00:00\",\"PLATFORMCODE\": \"EM_104972\"},{\"P_TYPE\":
		// \"2\",\"REGISTERTIME\": \"2016/6/5 0:00:00\",\"PLATFORMCODE\":
		// \"EM_110237\"},{\"P_TYPE\": \"2\",\"REGISTERTIME\": \"2016/10/7
		// 0:00:00\",\"PLATFORMCODE\": \"EM_100001\"},{\"P_TYPE\":
		// \"2\",\"REGISTERTIME\": \"2016/10/6 0:00:00\",\"PLATFORMCODE\":
		// \"EM_100001 \"}],\"CYCLE\": \"2015-12-05--2016-12-05\",\"TYPE\":
		// \"EMR002\"},{\"DATA\": [{\"P_TYPE\": \"2\",\"APPLICATIONAMOUNT\":
		// \"0W～0.2W\",\"APPLICATIONRESULT\": \" \",\"APPLICATIONTIME\":
		// \"2016/10/21 0:00:00\",\"PLATFORMCODE\": \"EM_100001\"},{\"P_TYPE\":
		// \"2\",\"APPLICATIONAMOUNT\": \"0W～0.2W\",\"APPLICATIONRESULT\": \"
		// \",\"APPLICATIONTIME\": \"2016/10/3 0:00:00\",\"PLATFORMCODE\":
		// \"EM_100001\"},{\"P_TYPE\": \"2\",\"APPLICATIONAMOUNT\":
		// \"0W～0.2W\",\"APPLICATIONRESULT\": \" \",\"APPLICATIONTIME\":
		// \"2016/10/6 0:00:00\",\"PLATFORMCODE\": \"EM_100001\"},{\"P_TYPE\":
		// \"2\",\"APPLICATIONAMOUNT\": \"0W～0.2W\",\"APPLICATIONRESULT\": \"
		// \",\"APPLICATIONTIME\": \"2016/10/5 0:00:00\",\"PLATFORMCODE\":
		// \"EM_100001\"},{\"P_TYPE\": \"2\",\"APPLICATIONAMOUNT\":
		// \"1W～3W\",\"APPLICATIONRESULT\": \" \",\"APPLICATIONTIME\":
		// \"2016/9/10 0:00:00\",\"PLATFORMCODE\": \"EM_100001\"},{\"P_TYPE\":
		// \"2\",\"APPLICATIONAMOUNT\": \"0W～0.2W\",\"APPLICATIONRESULT\": \"
		// \",\"APPLICATIONTIME\": \"2016/9/10 0:00:00\",\"PLATFORMCODE\":
		// \"EM_100001\"}],\"CYCLE\": \"2015-12-05--2016-12-05\",\"TYPE\":
		// \"EMR004\"}],\"CITY\": \"北京\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/loan/info", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/loan/info", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/loan/info", map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			// Map<String, Map<String,Object>> maps = gson.fromJson(kk,new
			// TypeToken<Map<String,Map<String,Object>>>(){}.getType());
	...
	public Map<String, Object> education_organizeD(String idCard, String name) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/education/organizeD", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/education/organizeD", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/education/organizeD", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
	...
	public Map<String, Map<String, String>> blacklist_search(String idCard, String name, String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161226145554373ApqfHyTjGftiguy\",\"data\":{\"blackLevel\":\"B\",\"blackReason\":\"T03\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/search", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/search", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/search", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readBlackList(String idCard, String name, String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161213150210248TjNXqhNNDWKARPr\",\"data\":{\"result\":{\"content\":[{\"desc\":\"命中次数
		// 1\",\"originalRet\":{\"app_mobile\":\"\",\"message\":\"网络公开负面信息\",\"home\":\"江西-南昌\",\"hit_num\":1,\"sex\":\"女\",\"app_qq\":\"\",\"hit_list\":[{\"publish_date\":\"2014-12-15\",\"source_url\":\"http://s.digcredit.com/urls/10020/9757709dbc7cb97a47e1c2def585b7da/\",\"province\":\"\",\"court\":\"\",\"file_time\":\"\",\"overdue_amount\":4980.05,\"comp_name\":\"武汉商贸职业学院\"}],\"age\":29,\"xingzuo\":\"天蝎座\",\"app_id_card\":\"36012119861115294X\",\"type\":\"C01\",\"app_name\":\"潘丽\"},\"type\":\"网络公开负面信息\",\"date\":\"\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/loanPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/loanPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// 调用数信网黑名单API
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/loanPlatform", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readMultiPlatform(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161213164108481HkYTOaePyhlATJm\",\"data\":{\"result\":{\"content\":[{\"desc\":\"【图】-
		// 工行逸贷,pos机招商,办理- 邯郸邯郸担保贷款-
		// 百姓网\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【图】-
		// 个人无抵押,无担保小额贷款,1-3天放款! -
		// 邯郸邯郸担保/贷款...\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"xiao13403307888_借款列表_个人主页_个人小额短期无抵押贷款_...\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【图】-
		// 工行逸贷建行E贷- 邢台邢台担保贷款-
		// 百姓网\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【图】- 工行逸贷建行E贷-
		// 邯郸邯郸担保/贷款- 百姓网\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【图】-
		// 工行逸贷建行E贷- 安阳安阳新区担保贷款-
		// 百姓网\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"...xiao13403307888的借款_个人小额短期无抵押贷款_P2P网..._拍拍贷\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【累积信用】xiao13403307888的首次借款—wap专享_
		// ... -
		// 拍拍贷\",\"type\":\"贷款相关\",\"date\":\"\"},{\"desc\":\"【网贷体验】听说网上能贷款，体验下网贷_xiao13403307888的借款_
		// ...\",\"type\":\"贷款相关\",\"date\":\"\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/loan/multiPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/loan/multiPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// 调用多次申请记录查询API
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/loan/multiPlatform", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readLoanOverdue(String idCard, String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/loanOverdue", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/loanOverdue", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// 调用网络公开逾期信息API
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/loanOverdue", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readBlacklistCheat(String idCard, String name, String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161213181030680ffGuAlglZbXRqIC\",\"data\":{\"result\":{\"content\":[{\"desc\":\"欺诈申请\",\"originalRet\":{\"loan_type\":\"\",\"name\":\"100\",\"confirm_type\":\"欺诈\",\"pid\":\"100\",\"applied_at\":\"\",\"confirm_details\":\"欺诈申请\",\"mobile\":\"0\",\"confirmed_at\":\"2012年08月01日\"},\"type\":\"欺诈\",\"date\":\"\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/cheat", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/cheat", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/cheat", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readInternetNegative(String phone) {
		...
		map.put("phone", phone);
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161216205655422RXmkXYUMaXWRUqL\",\"data\":{\"result\":{\"content\":[{\"desc\":\"<a
		// href=\"http://www.so.com/link?url=http%3A%2F%2Fwww.wangdaiyujing.com%2Fp2p-61919-1.html&q=18950848338&ts=1471514870&t=9f79f5217615ffde0e6cbf1e87e8aae&src=haosou\"
		// style=\"color:#E3AD1C\" target=\"_blank\">【P2PBLACK】出大事啦,那些老赖可怎么办!
		// _网贷预警网</a>\",\"originalRet\":{\"abstract\":\"赖永超 18950848338
		// 18950848338福建 35050019901020*闽西职业技术学院 3000 2334.23 杨国良 13133396573
		// 13133396573山西
		// 14270319890323*西安高新科技职业学...\",\"title\":\"【P2PBLACK】出大事啦,那些老赖可怎么办!
		// _网贷预警网\",\"no\":1,\"class\":\"黑名单\",\"search_word\":\"18950848338\",\"search_type\":\"phone\",\"url\":\"http://www.so.com/link?url=http%3A%2F%2Fwww.wangdaiyujing.com%2Fp2p-61919-1.html&q=18950848338&ts=1471514870&t=9f79f5217615ffde0e6cbf1e87e8aae&src=haosou\"},\"type\":\"黑名单\",\"date\":\"\"},{\"desc\":\"<a
		// href=\"http://www.baidu.com/link?url=HRWibRes9n6suQPw0Xg91wVhXteTlFqQpVpd4QmZnrEFGWZWzQMl8VwYDzCn6DGpgsC0j3EAHEElK5x5RSEyQq\"
		// style=\"color:#E3AD1C\" target=\"_blank\">贝才网借贷逾期黑名单
		// 望各大平台注意老赖-天眼数据-网贷天眼</a>\",\"originalRet\":{\"abstract\":\"2014年11月17日 - 赖永超
		// 18950848338 18950848338 福建 350500199010205535 闽西职业技术学院 3000 2334.23
		// 杨国良 13133396573 13133396573 山西 142703198903232416
		// ...\",\"title\":\"贝才网借贷逾期黑名单
		// 望各大平台注意老赖-天眼数据-网贷天眼\",\"no\":11,\"class\":\"黑名单\",\"search_word\":\"18950848338\",\"search_type\":\"phone\",\"url\":\"http://www.baidu.com/link?url=HRWibRes9n6suQPw0Xg91wVhXteTlFqQpVpd4QmZnrEFGWZWzQMl8VwYDzCn6DGpgsC0j3EAHEElK5x5RSEyQq\"},\"type\":\"黑名单\",\"date\":\"\"}]}}}";
		// {"errorCode":200,"errorMsg":"请求成功","uid":"20161216205655422RXmkXYUMaXWRUqL","data":{"result":{"content":[{"desc":"<a
		// href=\"http://www.so.com/link?url=http%3A%2F%2Fwww.wangdaiyujing.com%2Fp2p-61919-1.html&q=18950848338&ts=1471514870&t=9f79f5217615ffde0e6cbf1e87e8aae&src=haosou\"
		// style=\"color:#E3AD1C\" target=\"_blank\">【P2PBLACK】出大事啦,那些老赖可怎么办!
		// _网贷预警网</a>","originalRet":{"abstract":"赖永超 18950848338 18950848338福建
		// 35050019901020*闽西职业技术学院 3000 2334.23 杨国良 13133396573 13133396573山西
		// 14270319890323*西安高新科技职业学...","title":"【P2PBLACK】出大事啦,那些老赖可怎么办!
		// _网贷预警网","no":1,"class":"黑名单","search_word":"18950848338","search_type":"phone","url":"http://www.so.com/link?url=http%3A%2F%2Fwww.wangdaiyujing.com%2Fp2p-61919-1.html&q=18950848338&ts=1471514870&t=9f79f5217615ffde0e6cbf1e87e8aae&src=haosou"},"type":"黑名单","date":""},{"desc":"<a
		// href=\"http://www.baidu.com/link?url=HRWibRes9n6suQPw0Xg91wVhXteTlFqQpVpd4QmZnrEFGWZWzQMl8VwYDzCn6DGpgsC0j3EAHEElK5x5RSEyQq\"
		// style=\"color:#E3AD1C\" target=\"_blank\">贝才网借贷逾期黑名单
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/label", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/label", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/label", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
	...
	public Map<String, String> blacklistGamble(String phone) {
		...
		map.put("phone", phone);
		// String
		// kk="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161216112015658ZgRXWYjtmVRgpda\",\"data\":{\"result\":{\"content\":[{\"desc\":\"13524384545的个人空间_彩客网\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球胜负201503期方案:100437150
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150202期方案:99727487
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩混合过关20150301期方案:100430851
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"13524384545的个人空间_彩客网\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"13524384545的个人空间_彩客网\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150201期方案:97727442
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球胜负201502期方案:97595811
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球胜负201502期方案:99712532
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩让球胜平负20150301期方案:100489788
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"超级大乐透15015期方案:97557409
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球胜负201502期方案:97689257
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"超级大乐透15031期方案:100284165
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩混合过关20150202期方案:99520485
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球胜负201502期方案:97751148
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150301期方案:100489785
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"篮球混合过关201502期方案:97572774
		// --
		// 彩客\",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150103期方案:97029786
		// -- 彩客
		// \",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150201期方案:98433767
		// -- 彩客
		// \",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩胜平负20150201期方案:98405400
		// -- 彩客
		// \",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩让球胜平负20150201期方案:97530337
		// -- 彩客
		// \",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"竞彩让球胜平负20150201期方案:98185464
		// -- 彩客
		// \",\"type\":\"博彩\",\"date\":\"\"},{\"desc\":\"14场胜负彩2015018期方案：97507488
		// -- 彩客\",\"type\":\"博彩\",\"date\":\"\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/gamble", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/gamble", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/gamble", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> repeatedlyInquireB(String idCard, String name, String phone) {
		...
		map.put("phone", phone);
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161220144236902PoRmGyqrosKGpeC\",\"data\":{\"result\":{\"content\":[{}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/multiApplyCheckBlacklist", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/multiApplyCheckBlacklist", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/multiApplyCheckBlacklist", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> repeatedlyInquireA(String idCard, String name, String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/debtMultiPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/debtMultiPlatform", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/debtMultiPlatform", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> bankP2P(String idCard, String name, String phone) {
		...
		map.put("phone", phone);
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20170110115639265AZdQkDpLuPGvuPb\",\"data\":{\"result\":{\"content\":[{\"Flag\":{\"specialList_c\":\"1\"},\"SpecialList_c\":{\"id\":{\"abnormal\":\"0\"},\"cell\":{},\"gid\":{},\"lm_cell\":{}}}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/socialContact", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/socialContact", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/socialContact", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Map<String, String> CourtExecutePeople(String idCard, String name, String phone, String idType,
			String gender) {
		Map<String, String> map = new HashMap<String, String>();
		Map<String, String> data = new HashMap<String, String>();
		map.put("idCard", idCard);
		...
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161220162850089OIxXlqVjGgiyKpJ\",\"data\":{\"result\":{\"content\":[{\"cell_phone\":\"18691179115\",\"id_type\":1,\"baidu_account\":\"\",\"discredit_records\":{\"netloan\":null,\"tax\":null,\"court\":null},\"real_name\":\"吴燕\",\"imei\":\"\",\"gender\":1,\"id_no\":\"610628197707020043\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklist/loanCredit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklist/loanCredit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklist/loanCredit", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> phoneTagQuery(String phone) {
		...
		map.put("phone", phone);
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161220165426378ODcpeCEOyYHRwrh\",\"data\":{\"result\":{\"content\":[{\"tags\":[{\"count\":\"9\",\"tag_name\":\"济仁诊所\"}],\"phone\":\"13899787289\",\"com_address\":null,\"carrier\":\"新疆伊犁移动\",\"com_name\":null}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/phone/label", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/phone/label", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/phone/label", map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
			int sss = (int) (Double.parseDouble(gg.get("errorCode").toString()));
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Map<String, String> addresVerification(String idCard, String name, String phone, String idType,
			String homeCity, String homeAddress, String companyCity, String companyAddress) {
		Map<String, String> map = new HashMap<String, String>();
		Map<String, String> data = new HashMap<String, String>();
		map.put("idCard", idCard);
		map.put("name", name);
		...
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161220172036886lEqAWUKXHwZQOtW\",\"data\":{\"result\":{\"content\":[{\"cell_phone\":\"18691179115\",\"local_freq_address_list\":null,\"id_type\":1,\"baidu_account\":\"\",\"real_name\":\"吴燕\",\"imei\":\"\",\"company_address_list\":[{\"distance\":\"1252862.0\",\"verify_result\":\"D\"}],\"home_address_list\":null,\"nolocal_freq_address_list\":null,\"id_no\":\"610628197707020043\"}]}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/address/verify", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/address/verify", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/address/verify", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Map<String, Map<String, String>> baiduQuery(String phone, String name, String idCard, String maritalStatus,
			String degree, String homeAddress, String companyAddress) {
		Map<String, String> map = new HashMap<String, String>();
		Map<String, Map<String, String>> data = new HashMap<String, Map<String, String>>();
		map.put("phone", phone);
		map.put("name", name);
		...
		map.put("companyAddress", companyAddress);
		// String kk
		// ="{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161220175529058pfzZttkXoltdKpm\",\"data\":{\"lemon_A_pd\":\"0.1721499860\",\"lemon_B_pd\":\"0.0820594504\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/credit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/credit", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/credit",
	...
	public Map<String, String> readappKeys(String phone, String idCard, String name, String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/applyDataInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/applyDataInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/applyDataInfoQuery", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readCardUtil(String phone, String idCard, String name, String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/blacklistInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/blacklistInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/blacklistInfoQuery", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, Map<String, String>> readCardUtil(String phone, String idCard, String staffType) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/staffReportInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/staffReportInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/staffReportInfoQuery", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, Map<String, String>> readCaseReportInfo(String phone, String idCard, String caseType) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/caseReportInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/caseReportInfoQuery", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/caseReportInfoQuery", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readqueryQuota1(String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				kk = "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20170301160145932iCKqKKDEwVtVYmo\",\"data\":{\"statCode\":\"1000\",\"statMsg\":\"查询成功\",\"calCode\":2,\"validate\":\"1\",\"result\":{\"quota\":{\"S0279\":\"0.00\",\"S0622\":\"0\",\"S0618\":\"1\",\"S0618\":\"1\",\"S0574\":\"1611_NA;1610_NA\"},\"active\":null}}}";
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryQuota", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryQuota", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
		...
		Gson gson = new Gson();
		Map<String, Map<String, Map<String, Map<String, String>>>> re = gson.fromJson(kk, Map.class);
		Map<String, Object> gg = gson.fromJson(kk, Map.class);
		Map<String, Map<String, String>> ss = gson.fromJson(kk, Map.class);
		int sss = (int) (Double.parseDouble(gg.get("errorCode").toString()));
		if (sss == 200) {
			...
			if (getQuota.containsKey("S0574")) {
				...
				String liss = getQuota.get("S0574");
				if (liss.contains(";")) {
					String[] list;
					list = liss.split(";");
					for (int i = 0; i < list.length; i++) {
						if (list[i].contains("_")) {
							String[] list1;
							list1 = list[i].split("_");
							str.append(cityCodeService.findCityByCode(list1[0].trim())+":"+list1[1].trim()+";");
						}
					}
				}else if (liss.contains("_")) {
					String[] list1;
					list1 = liss.split("_");
					str.append(cityCodeService.findCityByCode(list1[0].trim())+":"+list1[1].trim()+";");
				}
				result.put("近3月交易金额城市分布", str.toString());
			}
			...
			if (getQuota.containsKey("S0583")) {
				StringBuffer str = new StringBuffer();
				String liss = getQuota.get("S0583");
				if (liss.contains(";")) {
					String[] list;
					list = liss.split(";");
					for (int i = 0; i < list.length; i++) {
				...
				result.put("近3月TOP3交易地列表", str.toString());
			}
			...
			if (getQuota.containsKey("S0082")) {
				StringBuffer str = new StringBuffer();
				String liss = getQuota.get("S0082");
				if (liss.contains(";")) {
					String[] list;
					list = liss.split(";");
					for (int i = 0; i < list.length; i++) {
				...
				result.put("近1月消费城市金额分布", str.toString());
			}
			String statCode = ss.get("data").get("statCode");
			if (("2000").equals(statCode) || ("2001").equals(statCode) || ("8000").equals(statCode)
					|| ("8001").equals(statCode) || ("8002").equals(statCode)) {
	...
	// */
	// @SuppressWarnings("unchecked")
	// public Map<String, Map<String, String>> readqueryQuota2(String bankCard){
	// Map<String ,String> map=new HashMap<String,String>();
	// Map<String, Map<String, String>> data = new HashMap<String, Map<String,
	// String>>();
	// map.put("bankCard", bankCard);
	// map.put("idCard", "511322198103024382");
	// map.put("phone", "13512345678");
	...
	// break;
	// case TEST:
	// kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryQuota", map,
	// Constants.APP_KEY, Constants.APP_KEY_VALUE);
	// break;
	// case NORMAL:
	// kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryQuota", map,
	// Constants.APP_KEY, Constants.APP_KEY_VALUE);
	// break;
	// }
	//// String kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryQuota",
	// map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
	// Gson gson =new Gson();
	// Map<String,Map<String,Map<String,String>>> re=gson.fromJson(kk,
	// Map.class);
	// Map<String,Object> gg=gson.fromJson(kk,Map.class);
	// int sss=(int)(Double.parseDouble(gg.get("errorCode").toString()));
	// if(sss==200){
	...
	// */
	// @SuppressWarnings("unchecked")
	// public Map<String, Map<String, String>> readqueryQuota3(String bankCard){
	// Map<String ,String> map=new HashMap<String,String>();
	// Map<String, Map<String, String>> data = new HashMap<String, Map<String,
	// String>>();
	// map.put("bankCard", bankCard);
	...
	// */
	// @SuppressWarnings("unchecked")
	// public Map<String, Map<String, String>> readqueryQuota4(String bankCard){
	// Map<String ,String> map=new HashMap<String,String>();
	// Map<String, Map<String, String>> data = new HashMap<String, Map<String,
	// String>>();
	// map.put("bankCard", bankCard);
	...
	// */
	// @SuppressWarnings("unchecked")
	// public Map<String, Map<String, String>> readqueryQuota5(String bankCard){
	// Map<String ,String> map=new HashMap<String,String>();
	// Map<String, Map<String, String>> data = new HashMap<String, Map<String,
	// String>>();
	// map.put("bankCard", bankCard);
	...
	public Map<String, Map<String, String>> phoneIsInBlacklist(String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/verifyPhoneIsInBlacklist", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/verifyPhoneIsInBlacklist", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/verifyPhoneIsInBlacklist", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, Map<String, String>> readIdPhoto(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20160912180520312vyCQuTQknMJQMVL\",\"data\":{
		// \"result\":\"1\", \"msg\":\"查询成功\",\"operatorType\": \"中国电信\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/mobileOperatorNameQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/mobileOperatorNameQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/mobileOperatorNameQuery ", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, Map<String, String>> readPhoto(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20160811101840779sEVSljbyBCjNiAC\",\"data\":{\"statusCode\":
		// \"2012\",\"statusMsg\": {\"debitCardCount\":
		// \"2\",\"creditCardCount\": \"0\",\"creditCardAging\":
		// {\"minIncluded\": null,\"maxIncluded\": null,\"min\": 0,\"max\":
		// 0,\"unit\": null},\"creditCardAge\": {\"minIncluded\":
		// null,\"maxIncluded\": null,\"min\": 0,\"max\": 0,\"unit\": null}}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryPhoneBankCardBindInfo ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryPhoneBankCardBindInfo ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/queryPhoneBankCardBindInfo ", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, Map<String, String>>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> readPhotoQuery(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20160811101840779sEVSljbyBCjNiAC\",\"data\":{\"statusCode\":\"2012\",\"statusMsg\":\"查询成功\",\"result\":{\"paymentShortTermVoloatilityIndex\":\"0\",\"depositShortTermVoloatilityIndex\":\"-6\",\"depositLongTermVoloatilityIndex\":\"1\"}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryActive ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryActive ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
	...
	public Map<String, String> readQueryLoadInfo(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20160811101840779sEVSljbyBCjNiAC\",\"data\":{\"statusCode\":\"2012\",\"statusMsg\":\"本数据库中未查得\",\"result\":{\"currentOutstandingLoanAmount\":{\"minIncluded\":\"否\",\"maxIncluded\":\"否\",\"min\":-1,\"max\":-1,\"unit\":\"元\"},\"currentOutstandingLoanCount\":{\"minIncluded\":\"是\",\"maxIncluded\":\"否\",\"min\":8000,\"max\":9000,\"unit\":\"元\"}}}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryLoadInfo ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryLoadInfo ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
	...
	public Map<String, String> readIdPhotoAccount(String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/queryAccountChangeLines", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/queryAccountChangeLines", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
	...
	public Map<String, String> mobileStatusQuery(String phone) {
		...
		map.put("phone", phone);
		// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
		// "/mobileStatusQuery ", map, Constants.APP_KEY,
		// Constants.APP_KEY_VALUE);
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/mobileStatusQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/mobileStatusQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
	...
	public Map<String, String> mobileOnlineIntervalQuery(String phone) {
		...
		map.put("phone", phone);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161212175927503EUbsfnUJYHXnZHD\",\"data\":{\"result\":\"1\",\"msg\":\"在网时长24个月以上\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/mobileOnlineIntervalQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/mobileOnlineIntervalQuery ", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/mobileOnlineIntervalQuery ", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> getIdPhoto(String name, String idCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/getIdPhoto", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/getIdPhoto", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/getIdPhoto", map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
	 ...
	 */
	// @SuppressWarnings("unchecked")
	// public Map<String, String> verify_education(String idCard,String
	// name,String levelNo) {
	// Map<String, String> map = new HashMap<String, String>();
	// Map<String, String> data = new HashMap<String, String>();
	// map.put("idCard", idCard);
	...
	// String kk =
	// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161210143154664llCfIKOZtUbURuT\",\"data\":{\"message\":\"交易成功\",\"checkStatus\":\"S\",\"checkResult\":{\"degree\":{\"isKeySubject\":\"N\",\"startTime\":\"20120901\",\"graduateTime\":\"2015\",\"degree\":\"硕士研究生\",\"studyResult\":\"毕业\",\"studyType\":\"研究生\",\"studyStyle\":\"全日制\",\"college\":\"北京理工大学\",\"levelNo\":\"100071201502001019\",\"photo\":\"\",\"specialty\":\"计算机科学与技术\",\"photoStyle\":\"JPG\"},\"personBase\":{\"originalAddress\":\"江西省景德镇市乐平市\",\"riskAndAdviceInfo\":\"1.此类人群工资收入处于中高水平，在有大专以上学历人群中，按工资收入水平从高到低排位，约在前10%至前35%左右。2.此类人群违约率普遍较低，在有大专以上学历人群中，按违约率从高到低排位，约在后10%左右。3.此类人群属于中高收入、低风险人群。4.此类人群建议给予较高程度的授信。\",\"birthday\":\"19910514\",\"graduateTime\":\"2015\",\"degree\":\"硕士研究生\",\"age\":\"25\",\"name\":\"周磊\",\"college\":\"北京理工大学\",\"graduateYears\":\"1\",\"gender\":\"1\",\"specialty\":\"计算机科学与技术\",\"verifyResult\":\"1\",\"documentNo\":\"360281199105148039\"},\"college\":{\"colgCharacter\":\"普通高等教育\",\"colgLevel\":\"本科\",\"postDoctorNum\":\"19\",\"is211\":\"Y\",\"masterDegreeNum\":\"144\",\"college\":\"北京理工大学\",\"colgType\":\"工科\",\"scienceBatch\":\"本科第一批\",\"character\":\"公办\",\"createYears\":\"76\",\"manageDept\":\"工业和信息化部\",\"academicianNum\":\"15\",\"address\":\"北京市\",\"collegeOldName\":\"北京理工大学\",\"keySubjectNum\":\"16\",\"doctorDegreeNum\":\"61\",\"createDate\":\"1940\",\"artBatch\":\"本科第一批\"},\"edu_result\":\"0\"}}}";
	// try {
	//// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
	// "/verify_education", map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
	// Gson gson =new Gson();
	// Map<String,Map<String,Map<String,String>>> re=gson.fromJson(kk,
	// Map.class);
	// Map<String,Object> gg=gson.fromJson(kk,Map.class);
	...
	public Map<String, String> bankcard2item(String bankCard, String name) {
		...
		map.put("bankCard", bankCard);
		// String kk =
		// "{\"errorCode\":200,\"errorMsg\":\"请求成功\",\"uid\":\"20161223163314782ttGfPlOutECRxXD\",\"data\":{\"checkStatus\":\"S\",\"message\":\"认证信息匹配\"}}";
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/bankcard2item", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/bankcard2item", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/bankcard2item", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> idNameImageCheck(String idCard, String name, String image) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/idNameImageCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/idNameImageCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/idNameImageCheck", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> bankcard4item(String name, String bankCard, String idCard, String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/bankcard4item", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/bankcard4item", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/bankcard4item", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> idNamePhoneCheck(String idCard, String name, String phone) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/idNamePhoneCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/idNamePhoneCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/idNamePhoneCheck", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> nameIdCardAccountVerify(String idCard, String name, String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/nameIdCardAccountVerify", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/nameIdCardAccountVerify", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/nameIdCardAccountVerify", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> nameIdCardAccountVerifyV(String idCard, String name, String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/nameIdCardAccountVerifyV", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/nameIdCardAccountVerifyV", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/nameIdCardAccountVerifyV", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> nameIdCardAccountVerifyF(String idCard, String name, String bankCard) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/nameIdCardAccountVerifyF", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/nameIdCardAccountVerifyF", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/nameIdCardAccountVerifyF", map, Constants.APP_KEY,
			// Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
	...
	public Map<String, String> idNameCheck(String idCard, String name) {
		...
		try {
			...
			case DEMO:
				...
				break;
			case TEST:
				kk = HttpUtils.sendPost(Constants.TEST_URL + "/idNameCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			case NORMAL:
				kk = HttpUtils.sendPost(Constants.NORMAL_URL + "/idNameCheck", map, Constants.APP_KEY,
						Constants.APP_KEY_VALUE);
				break;
			}
			// String kk = HttpUtils.sendPost(Constants.NORMAL_URL +
			// "/idNameCheck", map, Constants.APP_KEY, Constants.APP_KEY_VALUE);
			Gson gson = new Gson();
			Map<String, Map<String, String>> re = gson.fromJson(kk, Map.class);
			Map<String, Object> gg = gson.fromJson(kk, Map.class);
			int sss = (int) (Double.parseDouble(gg.get("errorCode").toString()));
