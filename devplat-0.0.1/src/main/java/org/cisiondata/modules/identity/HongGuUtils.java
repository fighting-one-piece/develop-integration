...
public class HongGuUtils {
	...
	public static String ToBase64(byte[] input) throws Exception {
	 ...
	 public static String requestPhoneHongda(String r)
	  {
		  String key = "cms1988";
		  String request = encry_RC4_string(r+"&cms1MHA-AL00862005038334104cms2", key);
		  return sj2qq(request);
	  }
	   public static String sj2qq(String request){
		  OutputStream os = null;
		  InputStream is = null;
		  String key = "cms1988";
		  String IP = "123.56.247.69";
		  int PORT = 10018;
