				...
				if (result.code == 1) {
					...
					if (result.data.statCode == "1000") {
						if (result.data.validate == 1) {
							var basic1 = "<table style='width:100%; word-break: break-all; word-wrap: break-word;'><tr>";
							var basic2 = "<tr>";
							var basic3 = "<table style='width:100%; word-break: break-all; word-wrap: break-word;'><tr>";
							var basic4 = "<tr>";
							var basic5 = "<table style='width:100%; word-break: break-all; word-wrap: break-word;'><tr>";
							var basic6 = "<tr>";
							var basic7 = "<table style='width:100%; word-break: break-all; word-wrap: break-word;'><tr>";
							var basic8 = "<tr>";
							var basic9 = "<table style='width:100%; word-break: break-all; word-wrap: break-word;'><tr>";
							var basic10 = "<tr>";
								$.each(result.data.result,function(key1,value1){
									if (key1 == "quota") {
										$.each(value1,function(key2,value2){
											//
											if (key2 == "S0660") {basic1 +="<td style='background: #EEE8AA;'>银行卡发卡地</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0661") {basic1 +="<td style='background: #EEE8AA;'>是否银联高端客户</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0464") {basic1 +="<td style='background: #EEE8AA;'>卡性质</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0467") {basic1 +="<td style='background: #EEE8AA;'>卡等级</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0462") {basic1 +="<td style='background: #EEE8AA;'>卡种</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0465") {basic1 +="<td style='background: #EEE8AA;'>卡品牌</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0466") {basic1 +="<td style='background: #EEE8AA;'>卡产品</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0468") {basic1 +="<td style='background: #EEE8AA;'>卡名称</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0469") {basic1 +="<td style='background: #EEE8AA;'>发卡行</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0517") {basic1 +="<td style='background: #EEE8AA;'>账户性质</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0549") {basic1 +="<td style='background: #EEE8AA;'>近3月交易总金额（消费类）</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0574") {basic1 +="<td style='background: #EEE8AA;'>近3月交易金额城市分布</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0575") {basic1 +="<td style='background: #EEE8AA;'>近3月交易笔数城市分布</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0576") {basic1 +="<td style='background: #EEE8AA;'>近3月交易天数城市分布</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0583") {basic1 +="<td style='background: #EEE8AA;'>近3月TOP3交易地列表</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0279") {basic1 +="<td style='background: #EEE8AA;'>近1月最大单日累计取现金额</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0618") {basic1 +="<td style='background: #EEE8AA;'>是否存在盗卡风险</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0622") {basic1 +="<td style='background: #EEE8AA;'>是否发生吞卡</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0148") {basic1 +="<td style='background: #EEE8AA;'>近1月消费高频商户分布</td>";basic2 +="<td>"+value2+"</td>";	}
											else if (key2 == "S0082") {basic1 +="<td style='background: #EEE8AA;'>近1月消费城市金额分布</td>";basic2 +="<td>"+value2+"</td>";	}
//											if (key2 == "S0659") {basic1 +="<td style='background: #EEE8AA;'>是否城市消费达人</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0477") {basic1 +="<td style='background: #EEE8AA;'>消费行业偏好</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0474") {basic1 +="<td style='background: #EEE8AA;'>还贷能力指标</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0660") {basic1 +="<td style='background: #EEE8AA;'>银行卡发卡地</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0661") {basic1 +="<td style='background: #EEE8AA;'>是否银联高端客户</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0464") {basic1 +="<td style='background: #EEE8AA;'>卡性质</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0467") {basic1 +="<td style='background: #EEE8AA;'>卡等级</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0462") {basic1 +="<td style='background: #EEE8AA;'>卡种</td>";basic2 +="<td>"+value2+"</td>";	}
...
//											else if (key2 == "S0469") {basic1 +="<td style='background: #EEE8AA;'>发卡行</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0517") {basic1 +="<td style='background: #EEE8AA;'>账户性质</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0677") {basic1 +="<td style='background: #EEE8AA;'>疑似套现行为甄别</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0618") {basic1 +="<td style='background: #EEE8AA;'>是否存在盗卡风险</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0622") {basic1 +="<td style='background: #EEE8AA;'>是否发生吞卡</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0623") {basic1 +="<td style='background: #EEE8AA;'>是否有超过笔数限制交易</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0624") {basic1 +="<td style='background: #EEE8AA;'>是否有金额超限类交易</td>";basic2 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0625") {basic1 +="<td style='background: #EEE8AA;'>是否有金额不足交易</td>";basic2 +="<td>"+value2+"</td>";	}
//
//											//
//											else if (key2 == "S0670") {basic3 +="<td style='background: #EEE8AA;'>信用卡还款金额</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0671") {basic3 +="<td style='background: #EEE8AA;'>信用卡还款笔数</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0210") {basic3 +="<td style='background: #EEE8AA;'>近1月信用卡还款 金额</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0211") {basic3 +="<td style='background: #EEE8AA;'>近6月信用卡还款 金额</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0213") {basic3 +="<td style='background: #EEE8AA;'>近1月信用卡还款 笔数</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0214") {basic3 +="<td style='background: #EEE8AA;'>近6月信用卡还款 笔数</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0049") {basic3 +="<td style='background: #EEE8AA;'>信用卡取现金额</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0050") {basic3 +="<td style='background: #EEE8AA;'>信用卡取现笔数</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0043") {basic3 +="<td style='background: #EEE8AA;'>近12月每月分期付款金额(各月明细)</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0044") {basic3 +="<td style='background: #EEE8AA;'>近12月每月分期付款笔数(各月明细)</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0132") {basic3 +="<td style='background: #EEE8AA;'>第一次分期付款日期</td>";basic4 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0133") {basic3 +="<td style='background: #EEE8AA;'>最近一次分期付款日期</td>";basic4 +="<td>"+value2+"</td>";	}
//											//
//											else if (key2 == "S0657") {basic5 +="<td style='background: #EEE8AA;'>是否结婚</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0658") {basic5 +="<td style='background: #EEE8AA;'>是否怀孕</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0674") {basic5 +="<td style='background: #EEE8AA;'>结婚日期</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0493") {basic5 +="<td style='background: #EEE8AA;'>孩子特征</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0662") {basic5 +="<td style='background: #EEE8AA;'>有无婚庆消费</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0491") {basic5 +="<td style='background: #EEE8AA;'>婚庆行业消费</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0470") {basic5 +="<td style='background: #EEE8AA;'>是否有房</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0663") {basic5 +="<td style='background: #EEE8AA;'>房产估值</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0516") {basic5 +="<td style='background: #EEE8AA;'>房产纳税额</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0471") {basic5 +="<td style='background: #EEE8AA;'>首笔房产消费时间</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0472") {basic5 +="<td style='background: #EEE8AA;'>是否有车</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0664") {basic5 +="<td style='background: #EEE8AA;'>车辆估值</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0652") {basic5 +="<td style='background: #EEE8AA;'>车辆消费金额</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0473") {basic5 +="<td style='background: #EEE8AA;'>首笔车辆消费时间</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0665") {basic5 +="<td style='background: #EEE8AA;'>车辆品牌消费</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0653") {basic5 +="<td style='background: #EEE8AA;'>车辆缴税、经销、修理金额</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0654") {basic5 +="<td style='background: #EEE8AA;'>车辆消费笔数</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0655") {basic5 +="<td style='background: #EEE8AA;'>车辆缴税、经销、修理笔数</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0492") {basic5 +="<td style='background: #EEE8AA;'>学生特征</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0494") {basic5 +="<td style='background: #EEE8AA;'>怀孕预产期</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0475") {basic5 +="<td style='background: #EEE8AA;'>是否无业</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0476") {basic5 +="<td style='background: #EEE8AA;'>消费档次</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0480") {basic5 +="<td style='background: #EEE8AA;'>消费性别</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0481") {basic5 +="<td style='background: #EEE8AA;'>消费年龄</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0503") {basic5 +="<td style='background: #EEE8AA;'>各年常住城市枚举</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0504") {basic5 +="<td style='background: #EEE8AA;'>近12月常住城市（交易天数最多）</td>";basic6 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0483") {basic5 +="<td style='background: #EEE8AA;'>近12月常住城市（交易笔数最多）</td>";basic6 +="<td>"+value2+"</td>";	}
//											//
//											else if (key2 == "S0656") {basic7 +="<td style='background: #EEE8AA;'>工作时间消费笔数占比</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0518") {basic7 +="<td style='background: #EEE8AA;'>每小时消费金额枚举</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0519") {basic7 +="<td style='background: #EEE8AA;'>每小时消费笔数枚举</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0520") {basic7 +="<td style='background: #EEE8AA;'>工作日的工作时间消费金额</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0521") {basic7 +="<td style='background: #EEE8AA;'>工作日的非工作时间消费金额</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0522") {basic7 +="<td style='background: #EEE8AA;'>工作日的工作时间消费笔数</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0523") {basic7 +="<td style='background: #EEE8AA;'>工作日的非工作时间消费笔数</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0524") {basic7 +="<td style='background: #EEE8AA;'>双休日消费金额</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0525") {basic7 +="<td style='background: #EEE8AA;'>双休日消费笔数</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0526") {basic7 +="<td style='background: #EEE8AA;'>节假日消费金额</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0527") {basic7 +="<td style='background: #EEE8AA;'>节假日消费笔数</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0528") {basic7 +="<td style='background: #EEE8AA;'>工作日的工作时间消费金额TOP10商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0529") {basic7 +="<td style='background: #EEE8AA;'>工作日的非工作时间消费金额TOP10商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0530") {basic7 +="<td style='background: #EEE8AA;'>工作日的工作时间消费笔数TOP10商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0531") {basic7 +="<td style='background: #EEE8AA;'>工作日的非工作时间消费笔数TOP10商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0487") {basic7 +="<td style='background: #EEE8AA;'>交易笔数TOP20 的餐饮商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0488") {basic7 +="<td style='background: #EEE8AA;'>交易笔数TOP20 的住宿商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0489") {basic7 +="<td style='background: #EEE8AA;'>交易笔数TOP20 的超市商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0490") {basic7 +="<td style='background: #EEE8AA;'>交易笔数TOP20 的零售商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0605") {basic7 +="<td style='background: #EEE8AA;'>近1月消费金额TOP1商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0606") {basic7 +="<td style='background: #EEE8AA;'>近1月消费笔数TOP1商户</td>";basic8 +="<td>"+value2+"</td>";	}
//											//
//											else if (key2 == "S0607") {basic9 +="<td style='background: #EEE8AA;'>近6月消费金额TOP1商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0608") {basic9 +="<td style='background: #EEE8AA;'>近6月消费笔数TOP1商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0609") {basic9 +="<td style='background: #EEE8AA;'>近12月消费金额TOP1商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0610") {basic9 +="<td style='background: #EEE8AA;'>近12月消费笔数TOP1商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0611") {basic9 +="<td style='background: #EEE8AA;'>近6月消费金额TOP5商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0612") {basic9 +="<td style='background: #EEE8AA;'>近6月消费笔数TOP5商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0613") {basic9 +="<td style='background: #EEE8AA;'>近12月消费金额TOP5商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0614") {basic9 +="<td style='background: #EEE8AA;'>近12月消费笔数TOP5商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0532") {basic9 +="<td style='background: #EEE8AA;'>双休日消费金额TOP10商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0533") {basic9 +="<td style='background: #EEE8AA;'>双休日消费笔数TOP10商户</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0499") {basic9 +="<td style='background: #EEE8AA;'>商圈次数TOP10</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0500") {basic9 +="<td style='background: #EEE8AA;'>品牌次数TOP10</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0145") {basic9 +="<td style='background: #EEE8AA;'>近1月消费高额商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0146") {basic9 +="<td style='background: #EEE8AA;'>近6月消费高额商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0147") {basic9 +="<td style='background: #EEE8AA;'>近12月消费高额商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0148") {basic9 +="<td style='background: #EEE8AA;'>近1月消费高频商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0149") {basic9 +="<td style='background: #EEE8AA;'>近6月消费高频商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0150") {basic9 +="<td style='background: #EEE8AA;'>近12月消费高频商户分布</td>";basic10 +="<td>"+value2+"</td>";	}
//											else if (key2 == "S0495") {basic9 +="<td style='background: #EEE8AA;'>工作时间、非工作时间交易区域</td>";basic10 +="<td>"+value2+"</td>";	}
										})
									}
								});
						}else {
						...
						$("#nav_result").append("<br>"+basic1+basic2+"</table>");
					}
...
//											else if (key2 == "S0495") {basic9 +="<td style='background: #EEE8AA;'>工作时间、非工作时间交易区域</td>";basic10 +="<td>"+value2+"</td>";	}
					...
					if (result.data.statCode == "2000") {
						$("#nav_result").append(result.data.statMsg);
					}
