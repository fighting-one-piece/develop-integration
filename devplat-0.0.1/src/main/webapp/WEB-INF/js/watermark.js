...
$(function(){
	function watermark(settings) {
        ...
        //获取页面最大宽度
        var page_width = $(defaultSettings.targBox).width();
        //获取页面最大长度
        var page_height =$(defaultSettings.targBox).height();
        ...
        var x;
        var y;
        var $trg= $(defaultSettings.targBox);
        ...
        for (var i = 0; i < defaultSettings.watermark_rows; i++) {
            ...
            for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                ...
                mask_div.setAttribute('class','watermark');
	...
	function readUserInfomation(){
		$.ajax({
			...
			success:function(result){
				var watermarkusername = "";
				watermarkusername += result.data.account;
				watermarkusername += "<br>";
				watermarkusername += result.data.nickname;
				if ("" != result.data.email) {
					watermarkusername += "<br>";
					watermarkusername += result.data.email;
				}
				watermark({ watermark_txt:watermarkusername });
			}
		});
	}
