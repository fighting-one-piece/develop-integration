...
<body>
	<div class="styleWhite">
		<button id="addGroup" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-plus"></i>添加</button>
	...
	<div id="light" class="whitecontent">
		<div class="styleWhite">
			...
			<table id="tableStyle"  class="table table-striped table-bordered">
				...
				<tr>
					<td colspan="4"><input id="add" type="button" value="添加"/></td>
				</tr>
			</table>
		</div>
	</div>
		...
		<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<td width="69" valign="middle">
						...
						<button style="width: 86px" name="remove_all" id="remove_all" class="btn btn-sm btn-success">全部移除<i class="glyphicon glyphicon-backward"></i></button>						
					</td>
