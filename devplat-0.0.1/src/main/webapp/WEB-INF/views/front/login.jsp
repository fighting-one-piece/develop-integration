...
<body style="background: #0ca3d2;">
    ...
    <div class="login">
      ...
      <div id="nav">
        <p><input id="username" type="text" name="username" class="input-medium validate[required]" value="cisiondata" placeholder="账号" onkeydown="EnterPressLogin();"></p>
        <p><input id="password" type="password" name="password" class="input-medium validate[required]" value="cisiondata123" placeholder="密码" onkeydown="EnterPressLogin();"></p>
