	...
	<div class="row" style="margin-top: 5px; width: 100%; height: 100%;">
		<div style="width: 16%; float: left; padding-left: 20px;">
			...
			<div id="nav_phone" style="display: none">
				<h5 align="center">&nbsp;</h5>
				<input id="selPhone" type="text" style="width: 200px;" placeholder="请输入手机号" /> 
					<input id="submitquery" type="button" value="搜索" />
			</div>
			<!-- 银行卡号查询 -->
			<div id="nav_bank">
				<h5 align="center">&nbsp;</h5>
				<div align="left">
						<input id="bankCard" type="text" style="width: 200px;" placeholder="请输入银行卡号" />
						<input id="lemonSub"  type="button" value="确定" />
