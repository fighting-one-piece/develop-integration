...
<script type="text/javascript"
	src="<%=basePath%>/js/modules/log/log.js"></script>

</head>
<body>
	<div  style="margin-top: 33px;" class="row">
		<div class="col-md-6">
			<button id="hotWords" class="btn btn-sm btn-info"
				style="margin-right: 1%; float: right;">热词搜索</button>
			<button id="orderTime" class="btn btn-sm btn-info" style="margin-right: 1%; float: right;">最近搜索</button>
		</div>
		<div class="input-group col-md-6"
			style="width: 180px; padding-right: 50px;">
			<input id="account" type="text" class="form-control"
				style="width: 160px; font-size: 12px;" onkeydown="EnterPressCard()"
				placeholder="输入要搜索的用户名..." /> <span class="input-group-btn">
				<button class="btn btn-default" type="button" id="submitAc">搜索</button>
			</span>
		</div>
	</div>
	<div>
	...
	<script type="text/javascript"
		src="<%=basePath%>/js/modules/log/time.js"></script>
</body>
</html>