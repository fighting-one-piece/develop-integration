...
public interface ResourceAttributeDAO {
	 ...
	 */
	public List<ResourceAttribute> findByCondition(Map<String,Object> params);
	 ...
	 * @return
	 */
	public int updateResourceAttributeById(ResourceAttribute resourceAttribute);
	 ...
	 * @return 新增成功后的id
	 */
	public long addResourceAttribute (ResourceAttribute resourceAttribute);
