...
public class AuthPermission extends PKAutoEntity<Long> {
	...
	public List<String> obtainOperateIdentities() {
		...
		if (hasPermission(AUTH_CREATE))
			permissions.add(CREATE);
		if (hasPermission(AUTH_READ))
			permissions.add(READ);
		if (hasPermission(AUTH_UPDATE))
			permissions.add(UPDATE);
		if (hasPermission(AUTH_DELETE))
