					...
					var html="<div id='content' class='content'>"+
								"<div class='styleWhite'>"+
									...
									"<table id='tableStyle'  class='table table-striped table-bordered'>"+
										...
										"</tr>"+
										"<tr>"+
											"<td colspan='4'><input id='update' type='button' class='btn btn-sm btn-info' value='修改'/></td>"+
										"</tr>"+
									"</table>"+
								"</div>"+
							"</div>";
		...
		success:function(result){
			...
			if(result.code == 1){
				$.each(result.data,function(i,data){
					...
					"<td><input type='button' class='btn btn-sm btn-info addpermissions' value='授权'/>&nbsp;&nbsp;<input type='button' class='btn btn-sm btn-info compile' value='编辑'/>&nbsp;&nbsp;<input type='button' class='btn btn-sm btn-info del' value='删除'/></td></tr>";
				});
