...
//			console.log(result.data)
			...
			if (result.code == 1) {
				...
				$("#business").append(result.data.business);
				...
				$("#Qualification").append(result.data.qualification);
				$("#bocaioriginal").append(result.data.bocaioriginal);
				$("#elder").append(result.data.elder);
				$("#accumulationfund").append(result.data.accumulationfund);
				$("#motherandbady").append(result.data.motherandbady);
				$("#healthproducts").append(result.data.healthproducts);
				$("#accountjd").append(result.data.accountjd);
				$("#accountht").append(result.data.accountht);
				
				var heji = result.data.logistics + result.data.account
						+ result.data.email + result.data.car
						...
						+ result.data.airplane + result.data.resume
						+ result.data.cybercafe + result.data.socialsecurity
						+ result.data.qqdata + result.data.qqqundata
						+ result.data.qqqunrelation
						+ result.data.qualification + result.data.bocaioriginal + result.data.elder 
						+ result.data.accumulationfund + result.data.motherandbady + result.data.healthproducts
						+ result.data.accountjd + result.data.accountht;
//				console.log(heji)
				$("#heji").append(heji);
			} 
			else {
