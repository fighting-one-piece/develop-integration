...
@Controller
@RequestMapping(value = "/apiorguser")
public class APIAUserController {
	private Logger LOG = LoggerFactory.getLogger(APIAUserController.class);
	...
	//新增用户
		@RequestMapping(value="/apiaddauser",method=RequestMethod.POST)
		@ResponseBody
		...
		//分页查询全部
		@RequestMapping(value="/apifindauser",method = RequestMethod.GET)
		@ResponseBody
		...
		//删除
		@RequestMapping(value="/apideleteauser",method = RequestMethod.POST)
		@ResponseBody
		...
		//根据账号添加秘钥
		@RequestMapping(value="/apiaddkeyauser",method = RequestMethod.POST)
		@ResponseBody
