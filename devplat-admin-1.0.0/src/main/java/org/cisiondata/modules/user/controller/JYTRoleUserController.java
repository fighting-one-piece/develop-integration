...
@Controller
@RequestMapping(value = "/jytorgrole")
public class JYTRoleUserController {
	...
	public WebResult selRole(int index, int pageSize) {
		...
		try {
			result.setCode(ResultCode.SUCCESS.getCode());
			result.setData(roleService.selJYTRoleByPage(index, pageSize));
		} catch (BusinessException bu) {
			result.setCode(bu.getCode());
	...
	public WebResult updateRoleByFlag(int  id,Boolean deleteFlag) {
		...
		try {
			result.setCode(ResultCode.SUCCESS.getCode());
			result.setData(roleService.updateJYTRoleByFlag(id,deleteFlag));
		} catch (BusinessException bu) {
			result.setCode(bu.getCode());
			result.setData(bu.getDefaultMessage());
		} catch (Exception e) {
	...
	public WebResult updateRole(String name, String identity, String desc, int id) {
		...
		try {
			result.setCode(ResultCode.SUCCESS.getCode());
			result.setData(roleService.updateJYTRole(name, identity, desc, id));
		} catch (BusinessException bu) {
			result.setCode(bu.getCode());
			result.setData(bu.getDefaultMessage());
		} catch (Exception e) {
	...
	public WebResult selResourceById(Long roleId){
		...
		try {
			result.setCode(ResultCode.SUCCESS.getCode());
			result.setData(resourceService.selJYTResourceById(roleId));
		}catch(BusinessException bu){
			result.setCode(bu.getCode());
			result.setData(bu.getDefaultMessage());
		} catch (Exception e) {
	...
	public WebResult addPermission(String resourceId, Long roleId){
		...
		try {
			result.setCode(ResultCode.SUCCESS.getCode());
			result.setData(resourceService.addJYTPermission(resourceId, roleId));
		}catch(BusinessException bu){
			result.setCode(bu.getCode());
			result.setData(bu.getDefaultMessage());
		} catch (Exception e) {
