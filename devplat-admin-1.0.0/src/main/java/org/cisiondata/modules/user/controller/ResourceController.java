...
public class ResourceController {
	...
	public WebResult addResourceCisionData(String name,String identity,String url) {
	...
	public WebResult editResourceCisionData(Long id,String name,String identity,String url) {
		WebResult result = new WebResult();
		try {
			Integer type = 3;
	...
	public WebResult qureyAllResourceCisionData(Integer page, Integer pageSize) {
		WebResult result = new WebResult();
		try {
			Integer type = 3;
	...
	public WebResult deleteResourceCisionData(Long id,Boolean deleteFlag) {
		WebResult result = new WebResult();
		try {
			Integer type = 3;
