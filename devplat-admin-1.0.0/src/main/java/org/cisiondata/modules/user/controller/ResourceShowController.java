 ...
 */
@Controller
@RequestMapping("/resourcepubshow")
public class ResourceShowController {
	private Logger LOG = LoggerFactory.getLogger(ResourceShowController.class);
	
	@Resource(name="iResourceAttributeService")
	private IResourceAttributeService iResourceAttributeService=null;
	
	//根据resourceid查询
	@RequestMapping(value="/findbyidcondition",method = RequestMethod.GET)
	@ResponseBody
	...
	//根据resourceid修改
	@RequestMapping(value="/updatebyidresourceattribute",method=RequestMethod.POST)
	@ResponseBody
