...
public interface ResourceAttributeDAO {
	 ...
	 */
	public int updateResourceAttributeByresourceId(ResourceAttribute resourceAttribute) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public ResourceAttribute findByIdResourceAttribute(long id)throws DataAccessException;
	/**
	 *保存费用
	 * @param resourceAttribute
	 * @return
	...
	public int updateResourceAttribute(ResourceAttribute resourceAttribute) throws DataAccessException;
