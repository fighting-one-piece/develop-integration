...
public interface ResourceDAO {
	 ...
	 * @return
	 */
	public List<Resource> findByCondition(Map<String,Object> params) throws DataAccessException;
	 ...
	 * @return
	 */
	public int updateResourceById(Resource resource) throws DataAccessException;
	 ...
	 * @return 新增成功后的id
	 */
	public int addResource (Resource resource) throws DataAccessException;
}
