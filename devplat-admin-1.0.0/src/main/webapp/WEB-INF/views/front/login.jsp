...
<body style="background: #0ca3d2;">
	<section class="container" style="  position: absolute; top: 40%;left: 50%;transform: translate(-50%, -50%);">
    <div class="login">
      <h1>CisionData</h1>
      ...
      <div id="nav">
        ...
        <p><input type="text" id="jcaptchaCode" name="jcaptchaCode" class="input-medium validate[required,ajax[ajaxJcaptchaCall]]" placeholder="验证码">
        	<img class="jcaptcha-btn jcaptcha-img" style="margin-left: 10px;" src="<%=basePath%>/jcaptcha.jpg" title="点击更换验证码">
