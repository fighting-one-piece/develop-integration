...
public class HtmlFileUtils {
	...
	public static void html2txt(String htmlPath, String txtPath) {
		...
		try {
			...
			Document document = Jsoup.parse(htmlFile, new FileCharsetDetector().guessFileEncoding(htmlFile));
			Elements tableElements = document.select("form table");
	...
	public static void main(String[] args) throws Exception {
		convertFile("F:\\document\\doc\\201612\\html\\");
	}
