...
public class AbstractESServiceV1Impl {
	...
	/** ES 搜索属性字段*/
	protected static Set<String> name_attributes = new HashSet<String>();
	protected static Set<String> phone_attributes = new HashSet<String>();
	protected static Set<String> idcard_attributes = new HashSet<String>();
	protected static Set<String> chinese_attributes = new HashSet<String>();
	protected static Set<String> identity_attributes = new HashSet<String>();
	protected static Set<String> location_attributes = new HashSet<String>();
	protected static Set<String> all_attributes = new HashSet<String>();
	
	/** ES TYPE INDEX 映射关系*/
	protected static Map<String, String> type_index_mapping = new HashMap<String, String>();
	
	/** ES INDEX TYPE 映射关系*/
	protected static Map<String, List<String>> index_types_mapping = new HashMap<String, List<String>>();
	
	/** ES INDEX TYPE ATTRIBUTES 映射关系*/
	protected static Map<String, Map<String, Set<String>>> index_type_attributes_mapping = 
			new HashMap<String, Map<String, Set<String>>>();
	
	/** 属性字段过滤*/
	protected static Set<String> filter_attributes = new HashSet<String>();
	/** 标识属性字段过滤*/
	protected static Set<String> identity_filter_attributes = new HashSet<String>();
