package org.mybatis.plugins.pagination.interceptor;
...
import org.mybatis.plugins.pagination.Dialect;
import org.mybatis.plugins.pagination.MySQL5Dialect;
...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
	    ...
	    if (parameterObject instanceof Map) {
            ...
            String pageSql = dialect.obtainPaginationSql(sql, offset, limit);
