...
//    private static final int REMEMBER_ME_BIT_MASK = 1 << bitIndexCounter++;
    private static final int USER_ID_BIT_MASK = 1;
    private static final int USER_AGENT_BIT_MASK = 1;
    private static final int STATUS_BIT_MASK = 1;
    private static final int USERNAME_BIT_MASK = 1;
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (isFieldPresent(bitMask, USERNAME_BIT_MASK) && null != in.readObject()) {
