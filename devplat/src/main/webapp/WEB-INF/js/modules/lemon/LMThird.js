$(document).ready(function() {
	...
	$("#lemonSub").click(function(){
		...
		if (bankCard == null || bankCard == "") {
			...
			$("#error").empty();
			$("#error").append("请输入身份证号");
		}else if (phone == null || phone == "") {
			$("#error").empty();
			$("#error").append("请输入电话号码");
		...
		$.ajax({
			...
			type:"post",
			dataType:"json",
			data:{"bankCard":bankCard,"idCard":idCard,"phone":phone,"name":name},
			success:function(result){
				...
				if (result.code == 1) {
					...
					if (result.data.statCode == "1000") {
						if (result.data.validate == 1) {
							...
							$("#basicresult18").append("未找到相关数据");
						}
						$("#basicresult18").append("<br>"+basic1+basic2+"</table>"+"<br>"+basic3+basic4+"</table>"+"<br>"+basic5+basic6+"</table>"+"<br>"+basic7+basic8+"</table>"+"<br>"+basic9+basic10+"</table>");
					}
					...
					if (result.data.statCode == "2000") {
						$("#basicresult18").append(result.data.statMsg);
					}
